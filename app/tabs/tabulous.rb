...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #---------------------------------------------------------------------------------------------------------#
      [    :teachers_tab       ,    'Teachers'       ,    teachers_path       ,    true        ,    true        ],
      [    :rosters_tab        ,    'Rosters'        ,    rosters_path        ,    true        ,    true        ],
      [    :grades_tab         ,    'Grades'         ,    grades_path         ,    true        ,    true        ],
  ...
  config.actions do
    [
      ...
      #------------------------------------------------------------------#
      [    :teachers       ,    :all_actions    ,    :teachers_tab       ],
      [    :rosters        ,    :all_actions    ,    :rosters_tab        ],
      [    :grades         ,    :all_actions    ,    :grades_tab         ],
      [    :students       ,    :all_actions    ,    :students_tab       ],
      [    :courses        ,    :all_actions    ,    :courses_tab        ],
      [    :assignments    ,    :all_actions    ,    :assignments_tab    ],
